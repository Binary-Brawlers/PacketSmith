...
| `ps-request-engine` | `ProtocolExecutor` trait, execution context, event streaming | `ps-domain` |
...
| `packetsmith-app` | Desktop binary, GPUI window boot, app coordinator | `ps-domain`, `ps-workspace`, `ps-storage`, `ps-request-engine`, `ps-http`, `ps-ui-components`, `ps-settings` |
